...
//	cout << setprecision(11);
    ...
    TESTCASES {
        ...
        int o1 = odds.size() / 2, e1 = evens.size() / 2, flag = 1;
        vi a1, a2;
        REP(i, 0, o1) {
            // sum is a[i], diff is a[n1 + i]
            // a + b = x
            // a - b = y
            // a = (x + y) / 2
            // both should be odd or even
            int x1 = (odds[i] + odds[o1 + i]) / 2;
            int x2 = (odds[i] - odds[o1 + i]) / 2;
        ...
        REP(i, 0, e1) {
            ...
            // a = (x + y) / 2
            // both should be odd or even
            int x1 = (evens[i] + evens[e1 + i]) / 2;
            int x2 = (evens[i] - evens[e1 + i]) / 2;
            a1.push_back(x1), a2.push_back(x2);
        }
//        if (!flag) {
//            cout << "-1\n";
