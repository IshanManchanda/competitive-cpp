...
//	cout << setprecision(11);
    ...
    ll max_n = 10'000'000;
    // use Sieve of Eratosthenes to get a list of all primes less than max_n
    ...
    // odd - odd can never be prime. we first check if 2 is present, and then
    // test all odd numbers against 2.
