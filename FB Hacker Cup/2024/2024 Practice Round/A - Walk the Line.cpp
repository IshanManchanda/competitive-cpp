...
//	cout << setprecision(11);
    ...
    TESTCASES1 {
        ...
        cinai(a, n);
        sort(all(a));
        // a0 takes a1 across, then comes back, then takes a2 across, ... until aN.
        // goes forward n - 1 times, comes back n - 2 times. so 2n - 3.
        ll times = max(2 * n - 3, 1ll);
        CASEOUT << (times * a[0] <= k ? "YES" : "NO") << endl;
    }
