...
#define NEW_PROBLEM
    ...
    // palindrome iff freq of each character is even, except at most 1
    // for each string, we can find a 26-bit string representing even-odd
    // should have at most 1 '1' after XORing
    // for the current string, if there already is a 1 somewhere
    // then this needs to be set to 0 (so the other should be 1)
    // and then all but one bit should be 0
    // we can iterate over the one bit
